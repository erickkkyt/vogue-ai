...
export async function POST(request: NextRequest) {
  try {
    ...
    const n8nWebhookUrl = process.env.N8N_BABY_GENERATION_WEBHOOK_URL || 'https://n8n-avskrukq.us-east-1.clawcloudrun.com/webhook-test/8f637ae5-7aff-410f-8de3-a9910cfc1ad9'; // Baby Generator specific N8N Webhook URL with fallback
