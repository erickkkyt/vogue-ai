...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
          ...
          <div className="p-12">{/* Content will continue here */}
            ...
            <div className="mb-10">
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-6">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start p-4 bg-white rounded-lg border border-gray-100">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-4 flex-shrink-0"></span>
                    <div>
                      <strong className="text-gray-800">Account Information</strong>: When you create an account, we collect information such as your name, email address, and profile details.
                    </div>
                  </li>
                  <li className="flex items-start p-4 bg-white rounded-lg border border-gray-100">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-4 flex-shrink-0"></span>
                    <div>
                      <strong className="text-gray-800">Payment Information</strong>: If you make a purchase or subscribe to a paid plan, we collect billing information, such as credit card numbers or other payment methods.
                    </div>
                  </li>
                </ul>

                <h3 className="text-xl font-semibold mb-4 text-gray-800 flex items-center mt-8">
                  <span className="w-2 h-2 bg-blue-500 rounded-full mr-3"></span>
                  Usage Data
                </h3>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="grid gap-4">
                  <div className="flex items-start p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-4 flex-shrink-0"></span>
                    <div>
                      <strong className="text-gray-800">To Provide and Improve Our Services</strong>: We use your data to deliver the features and functionality of the product, improve performance, and troubleshoot issues.
                    </div>
                  </div>
                  <div className="flex items-start p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-4 flex-shrink-0"></span>
                    <div>
                      <strong className="text-gray-800">To Communicate with You</strong>: We may send you service-related emails, notifications, or marketing communications if you have opted into them.
                    </div>
                  </div>
                  <div className="flex items-start p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-4 flex-shrink-0"></span>
                    <div>
                      <strong className="text-gray-800">To Process Payments</strong>: If applicable, we use payment information to process transactions and provide billing support.
                    </div>
                  </div>
                  <div className="flex items-start p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-4 flex-shrink-0"></span>
                    <div>
                      <strong className="text-gray-800">For Legal and Security Purposes</strong>: We may use your information to comply with legal obligations or protect our users and services from fraudulent activity.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-4 flex-shrink-0"></span>
                    <div>
                      <strong className="text-gray-800">Third-Party Service Providers</strong>: We use third-party companies to support our business, such as payment processors, analytics services, and cloud storage providers. These partners are required to keep your information confidential and only use it to provide services to us.
                    </div>
                  </div>
                  <div className="flex items-start p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-4 flex-shrink-0"></span>
                    <div>
                      <strong className="text-gray-800">Legal Compliance</strong>: We may disclose your information if required by law or to comply with legal processes, such as subpoenas or court orders.
                    </div>
                  </div>
                  <div className="flex items-start p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-4 flex-shrink-0"></span>
                    <div>
                      <strong className="text-gray-800">Business Transfers</strong>: In the event of a merger, acquisition, or sale of all or part of our assets, your personal information may be transferred.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="grid gap-4">
                  <div className="flex items-start p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-4 flex-shrink-0"></span>
                    <div>
                      <strong className="text-gray-800">Access and Correction</strong>: You can request access to the personal information we hold about you and request corrections if the information is inaccurate or incomplete.
                    </div>
                  </div>
                  <div className="flex items-start p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-4 flex-shrink-0"></span>
                    <div>
                      <strong className="text-gray-800">Data Deletion</strong>: You can request that we delete your personal information, subject to legal and contractual obligations.
                    </div>
                  </div>
                  <div className="flex items-start p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-4 flex-shrink-0"></span>
                    <div>
                      <strong className="text-gray-800">Opt-Out of Marketing</strong>: You can opt-out of receiving marketing emails or notifications at any time by following the unsubscribe instructions provided in the communication.
                    </div>
                  </div>
                  <div className="flex items-start p-4 bg-white rounded-lg border border-gray-100 shadow-sm">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-4 flex-shrink-0"></span>
                    <div>
                      <strong className="text-gray-800">Data Portability</strong>: You may request a copy of your personal data in a structured, commonly used format.
                    </div>
                  </div>
                </div>
                <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                  <p className="text-gray-700">
                    If you wish to exercise any of these rights or have questions about how we handle your data, please contact us at <a href="mailto:support@vogueai.net" className="text-blue-600 hover:text-blue-800 underline font-medium">support@vogueai.net</a>.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="p-4 bg-white rounded-lg border border-gray-100">
                  <p className="text-gray-700">
                    <strong className="text-gray-800">Email</strong>: <a href="mailto:support@vogueai.net" className="text-blue-600 hover:text-blue-800 underline font-medium">support@vogueai.net</a>
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* Back to Home Button */}
      <Link href="/" className="fixed bottom-8 right-8 bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white font-semibold py-4 px-6 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-105 z-50 flex items-center space-x-2">
