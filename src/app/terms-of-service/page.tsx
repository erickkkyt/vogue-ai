...
export default function TermsOfServicePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-100">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-purple-600 to-indigo-700 py-24">
      ...
      <div className="container mx-auto max-w-4xl px-6 py-16">
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
          <div className="p-12">{/* Content will continue here */}
            ...
            {/* Introduction */}
            <div className="mb-12 p-8 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl border-l-4 border-purple-500">
              <p className="text-lg leading-relaxed text-gray-700">
                By accessing and using <strong className="text-purple-600">VOGUE AI</strong> ("the Service"), you agree to comply with and be bound by the following Terms of Use ("Terms") related to the use of Google Login. If you do not agree to these Terms, please do not use the Service or the Google Login functionality.
              </p>
            </div>
            ...
            <div className="mb-10">
              <h2 className="text-3xl font-bold mb-6 text-gray-900 flex items-center">
                <span className="w-10 h-10 bg-purple-500 text-white rounded-full flex items-center justify-center text-lg font-bold mr-4">1</span>
                Google Login Integration
              </h2>
              <div className="bg-gray-50 rounded-xl p-6">
                <div className="p-4 bg-white rounded-lg border border-gray-100 mb-4">
                  <p className="text-gray-700 leading-relaxed mb-4">
                    1.1. To enhance your experience, <strong className="text-purple-600">VOGUE AI</strong> offers a third-party authentication service powered by Google Login. By using Google Login, you allow us to access certain information from your Google Account, including but not limited to:
                  </p>
                  <ul className="space-y-2 ml-4">
                    <li className="flex items-start">
                      <span className="w-1.5 h-1.5 bg-purple-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                      <div>
                        <strong className="text-gray-800">Your Google Account Profile Information</strong>: Your name, email address, profile picture, and other details that you have chosen to share with Google.
                      </div>
                    </li>
                    <li className="flex items-start">
                      <span className="w-1.5 h-1.5 bg-purple-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                      <div>
                        <strong className="text-gray-800">Authentication Token</strong>: A secure token that confirms your identity and grants you access to the Service.
                      </div>
                    </li>
                  </ul>
                </div>
      ...
      <section className="mb-8 p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        ...
        <ul className="list-disc list-inside mb-4 space-y-1 pl-8">
          ...
          <li>
            <strong>Payment Failure</strong>: If VOGUE AI does not receive payment upon renewal of your subscription, (i) you shall pay all amounts due on your account upon demand, and/or (ii) you agree that VOGUE AI may either terminate or suspend your subscription and continue to attempt to charge your designated payment method until payment is received (upon receipt of payment, your account will be activated and for purposes of automatic renewal, your new subscription commitment period will begin as of the day payment was received).
          </li>
          <li>
            <strong>Cancellation</strong>: If you do not want your account to renew automatically, or if you want to change or terminate your subscription, you must do so through your account settings or contact VOGUE AI at <a href="mailto:support@vogueai.net" className="text-blue-600 hover:underline dark:text-blue-400">support@vogueai.net</a> prior to the next renewal date. If you purchased your subscription through a third-party application store, you must cancel, change, or terminate your subscription through such third-party application store before your renewal start date.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside mb-4 space-y-1 pl-8">
          ...
          <li>
            <strong>Refund Requests</strong>: All refund requests (if eligible under the exceptions above) must be submitted to <a href="mailto:support@vogueai.net" className="text-blue-600 hover:underline dark:text-blue-400">support@vogueai.net</a> with details of the purchase and the reason for the request. We will evaluate your request in accordance with this policy.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8 p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        ...
        <p className="mb-2">
          11.1. To the fullest extent permitted by law, <strong>VOGUE AI</strong> shall not be liable for any direct, indirect, incidental, consequential, or special damages arising from the use of Google Login, including any issues related to authentication, security breaches, or data loss.
        </p>
        <p className="mb-2">
      ...
      <section className="mb-8 p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
        ...
        <p>
          14.4. Our failure to enforce any provision shall not constitute a waiver.
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold mb-6 text-gray-900 flex items-center">
                <span className="w-10 h-10 bg-purple-500 text-white rounded-full flex items-center justify-center text-lg font-bold mr-4">15</span>
                Contact Us
              </h2>
              <div className="bg-gray-50 rounded-xl p-6 space-y-4">
                ...
                <div className="p-4 bg-white rounded-lg border border-gray-100">
                  ...
                  <p className="text-gray-700">
                    <strong className="text-gray-800">Email</strong>: <a href="mailto:support@vogueai.net" className="text-purple-600 hover:text-purple-800 underline font-medium">support@vogueai.net</a>
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* Back to Home Button */}
      <Link href="/" className="fixed bottom-8 right-8 bg-gradient-to-r from-purple-600 to-indigo-700 hover:from-purple-700 hover:to-indigo-800 text-white font-semibold py-4 px-6 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-105 z-50 flex items-center space-x-2">
