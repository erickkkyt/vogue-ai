...
export default function EarthZoomShowcase() {
  ...
  return (
    <section id="showcase" className="py-20 bg-gradient-to-b from-[var(--vogue-page)] to-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {showcaseVideos.map((video, index) => (
            ...
            >
              {/* Video Card */}
              <div className="relative bg-gradient-to-br from-white/90 to-[#f7fbff]/90 backdrop-blur-sm border border-slate-200 rounded-2xl overflow-hidden shadow-[0_18px_46px_rgba(72,92,130,0.12)] group-hover:shadow-blue-500/20 transition-all duration-500 group-hover:scale-[1.02] group-hover:border-blue-100/30">
                <div className="relative aspect-[16/9] overflow-hidden">
                  ...
                  {/* Overlay */}
                  <div className="absolute inset-0 bg-gradient-to-t from-[var(--vogue-page)]/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300">
                ...
                {/* Prompt Box */}
                <div className="p-6">
                  <div className="bg-white/78 rounded-xl border border-slate-200 p-4">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 transition-colors duration-200 group/btn"
                        title="Copy prompt"
                      >
                        {copiedPrompt === video.id ? (
                          ...
                          <svg className="w-4 h-4 text-slate-500 group-hover/btn:text-white transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-50 to-green-50 border border-blue-100/50 rounded-2xl p-8 max-w-4xl mx-auto backdrop-blur-md">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                href="#dashboard"
                className="bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-500 hover:to-green-500 text-white font-bold py-3 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-[0_12px_30px_rgba(72,92,130,0.1)]"
              >
                Start Creating Now
              </a>
