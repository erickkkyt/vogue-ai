...
export default function EarthZoomAbout() {
  return (
    <section id="about" className="py-20 bg-gradient-to-b from-[var(--vogue-page)] to-white">
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-600/20 to-green-600/20 rounded-2xl p-8 backdrop-blur-md border border-slate-200">
                <div className="space-y-4">
                  ...
                  <div className="mt-4 bg-white/78 rounded-lg p-3">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {/* Step 1 */}
              <div className="bg-white/86 rounded-xl p-6 border border-slate-200 relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-cyan-500"></div>
                <div className="text-4xl font-bold text-blue-400 mb-4">01</div>
                <h4 className="text-xl font-bold text-slate-950 mb-3">Image Analysis</h4>
              ...
              <div className="bg-white/86 rounded-xl p-6 border border-slate-200 relative overflow-hidden">
                ...
                <h4 className="text-xl font-bold text-slate-950 mb-3">3D Mapping</h4>
                <p className="text-slate-600 text-sm leading-relaxed">
              ...
              <div className="bg-white/86 rounded-xl p-6 border border-slate-200 relative overflow-hidden">
                ...
                <h4 className="text-xl font-bold text-slate-950 mb-3">Motion Synthesis</h4>
                <p className="text-slate-600 text-sm leading-relaxed">
              ...
              <div className="bg-white/86 rounded-xl p-6 border border-slate-200 relative overflow-hidden">
                ...
                <h4 className="text-xl font-bold text-slate-950 mb-3">Video Rendering</h4>
                <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              <div className="bg-gradient-to-br from-green-600/10 to-blue-600/10 rounded-2xl p-8 border border-slate-200">
                <div className="space-y-6">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white/86 rounded-xl p-6 border border-slate-200">
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-bold text-slate-950 mb-2">Output Quality</h4>
              ...
              <div className="bg-white/86 rounded-xl p-6 border border-slate-200">
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-bold text-slate-950 mb-2">Performance</h4>
                  <div className="space-y-2 text-slate-600">
              ...
              <div className="bg-white/86 rounded-xl p-6 border border-slate-200">
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-bold text-slate-950 mb-2">AI Models</h4>
                  <div className="space-y-2 text-slate-600">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-gradient-to-br from-blue-600/10 to-purple-600/10 rounded-xl p-6 border border-slate-200 text-center">
                ...
                <h4 className="text-lg font-bold text-slate-950 mb-2">Social Media</h4>
                <p className="text-slate-600 text-sm">Eye-catching content for TikTok, Instagram, and YouTube</p>
              </div>

              <div className="bg-gradient-to-br from-green-600/10 to-teal-600/10 rounded-xl p-6 border border-slate-200 text-center">
                ...
                <h4 className="text-lg font-bold text-slate-950 mb-2">Real Estate</h4>
                <p className="text-slate-600 text-sm">Stunning property showcases and location highlights</p>
              </div>

              <div className="bg-gradient-to-br from-yellow-600/10 to-orange-600/10 rounded-xl p-6 border border-slate-200 text-center">
                ...
                <h4 className="text-lg font-bold text-slate-950 mb-2">Travel & Tourism</h4>
                <p className="text-slate-600 text-sm">Breathtaking destination reveals and travel documentaries</p>
              </div>

              <div className="bg-gradient-to-br from-red-600/10 to-pink-600/10 rounded-xl p-6 border border-slate-200 text-center">
                ...
                <h4 className="text-lg font-bold text-slate-950 mb-2">Film & Production</h4>
                <p className="text-slate-600 text-sm">Professional establishing shots and cinematic sequences</p>
              </div>
            </div>
          </div>
        </div>
