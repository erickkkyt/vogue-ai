...
function StepIndicator({ 
  ...
  return (
    <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "#374151", color: "#9ca3af", borderColor: "#4b5563" },
          active: { scale: 1, backgroundColor: "#3b82f6", color: "#ffffff", borderColor: "#60a5fa" },
          complete: { scale: 1, backgroundColor: "#10b981", color: "#ffffff", borderColor: "#34d399" },
        }}
