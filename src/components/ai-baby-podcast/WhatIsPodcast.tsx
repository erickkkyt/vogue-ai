...
export default function WhatIs() {
  ...
  return (    <section id="whatIs" className="py-20 bg-[var(--vogue-page)]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          <div className="bg-white/78 rounded-3xl p-8 md:p-12 relative overflow-hidden border border-slate-200">
            {/* Background Pattern */}
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                {youtubeShorts.map((video, index) => (
                  <div key={index} className="bg-white/86 rounded-xl overflow-hidden border border-slate-300 hover:border-slate-400 transition-all duration-300 group">
                    ...
                    <div className="p-3">
                      <h4 className="text-slate-950 text-sm font-medium group-hover:text-blue-400 transition-colors duration-200">
                        {video.title}
                      </h4>
                    </div>
                  </div>
              ...
              <div className="text-center mt-8">
                <a
                  href="#dashboard"
                  className="inline-flex items-center px-6 py-3 bg-blue-50 rounded-full text-blue-700 font-medium border border-blue-100 hover:bg-blue-100 hover:text-blue-800 transition-all duration-300"
                >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white/78 rounded-xl p-6 border border-slate-200">
            ...
            <h3 className="text-lg font-medium text-slate-950 mb-2">Novel Content Format</h3>
            <p className="text-slate-600">The BabyPodcast format offers a novel twist on traditional podcasts, making complex topics more accessible and entertaining.</p>
          </div>
          ...
          <div className="bg-white/78 rounded-xl p-6 border border-slate-200">
            ...
            <h3 className="text-lg font-medium text-slate-950 mb-2">Faceless Content Creation</h3>
            <p className="text-slate-600">BabyPodcast allows creators to produce high-engagement, faceless content optimized for algorithm-based distribution platforms without revealing their identity.</p>
          </div>
          ...
          <div className="bg-white/78 rounded-xl p-6 border border-slate-200">
            ...
            <h3 className="text-lg font-medium text-slate-950 mb-2">Evolving Technology</h3>
            <p className="text-slate-600">The BabyGenerator phenomenon represents the perfect intersection of AI technology, creative content production, and social media virality.</p>
          </div>
        </div>
      </div>
    </section>
