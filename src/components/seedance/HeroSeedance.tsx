        ...
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-[600px]">
          ...
          <div className="lg:w-1/2 text-center lg:text-left mb-12 lg:mb-0">
            ...
            <div className="inline-flex items-center bg-gradient-to-r from-green-500/20 to-blue-500/20 border border-green-500/30 rounded-full px-4 py-2 mb-6 backdrop-blur-sm">
              <span className="text-green-400 text-sm font-medium">🎭 Next-Generation AI Video Creation</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed max-w-2xl">
              Experience next-generation video creation with Seedance AI. Transform text descriptions or static images into dynamic dance videos through advanced AI technology that integrates motion synthesis, visual effects, and temporal coherence.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <div className="flex items-center text-green-400">
                ...
                <span className="font-medium">Dual Generation Modes</span>
              </div>
              ...
              <div className="flex items-center text-purple-400">
                ...
                <span className="font-medium">Advanced Motion Synthesis</span>
              </div>
            </div>
