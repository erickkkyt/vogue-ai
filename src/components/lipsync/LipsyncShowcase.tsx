    ...
    <section className="relative py-24 bg-gradient-to-b from-[var(--vogue-page)] via-white to-white overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl md:text-7xl font-bold text-slate-950 mb-8 leading-tight">
          ...
          <div className="flex flex-wrap justify-center gap-12 mt-16">
            <div className="text-center">
              ...
              <div className="text-slate-500 text-sm font-medium">Sync Accuracy</div>
            </div>
            <div className="text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="group relative bg-white/78 backdrop-blur-md border border-slate-200 rounded-3xl p-8 hover:border-pink-500/30 transition-all duration-300 hover:bg-white/78">
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-rose-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-[0_12px_30px_rgba(72,92,130,0.1)] group-hover:scale-105 transition-transform duration-300">
                <Sparkles className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-slate-950 mb-4 group-hover:text-pink-400 transition-colors duration-300">
          ...
          <div className="group relative bg-white/78 backdrop-blur-md border border-slate-200 rounded-3xl p-8 hover:border-pink-500/30 transition-all duration-300 hover:bg-white/78">
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-[0_12px_30px_rgba(72,92,130,0.1)] group-hover:scale-105 transition-transform duration-300">
                <TrendingUp className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-slate-950 mb-4 group-hover:text-emerald-400 transition-colors duration-300">
                99.9% Accuracy
              </h3>
              <p className="text-slate-600 text-lg leading-relaxed">
          ...
          <div className="group relative bg-white/78 backdrop-blur-md border border-slate-200 rounded-3xl p-8 hover:border-pink-500/30 transition-all duration-300 hover:bg-white/78">
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-[0_12px_30px_rgba(72,92,130,0.1)] group-hover:scale-105 transition-transform duration-300">
                <Video className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-slate-950 mb-4 group-hover:text-blue-400 transition-colors duration-300">
        ...
        <div className="text-center mt-20">
          <div className="bg-white/78 border border-slate-200 rounded-3xl p-10 max-w-4xl mx-auto backdrop-blur-md relative overflow-hidden">
            {/* Subtle Background */}
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <a
                  href="#dashboard"
                  className="inline-flex items-center bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-500 hover:to-rose-500 text-white font-semibold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-[0_12px_30px_rgba(72,92,130,0.1)] hover:shadow-xl"
                >
