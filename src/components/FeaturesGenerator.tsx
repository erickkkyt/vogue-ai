...
export default function FeaturesGenerator() {
  const features = [
    {
      icon: (
      ...
      title: "Parent Photo Combination",
      description: "Upload photos of both parents and our AI will intelligently combine their features to create realistic baby predictions."
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Generate ultra-realistic baby photos with advanced AI technology that captures fine details and natural expressions."
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Choose from various artistic styles and filters to create unique baby images that match your preferences."
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Get your baby photos in seconds with our optimized AI processing pipeline. No waiting, just instant results."
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Your photos are processed securely and deleted after generation. We prioritize your privacy and data security."
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
