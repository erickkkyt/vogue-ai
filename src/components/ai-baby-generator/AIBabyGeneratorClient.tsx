...
const WATERMARK_FREE_THRESHOLD = 8; // 8 credits required for watermark-free access
                ...
                <div className="space-y-6">
                  <div className="relative group">
                    <div className="aspect-square bg-gradient-to-br from-purple-600 to-pink-600 p-1 rounded-2xl shadow-2xl">
                      <div className="w-full h-full bg-gray-900 rounded-xl overflow-hidden">
                        <img
                          src={validCredits >= WATERMARK_FREE_THRESHOLD ? generatedBaby : `/api/baby/add-watermark?url=${encodeURIComponent(generatedBaby)}`}
                          alt="Generated baby"
                    ...
                    {/* 水印提示标签 */}
                    {validCredits < WATERMARK_FREE_THRESHOLD && (
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <div className="text-sm text-gray-400 mb-4">
                      {validCredits >= WATERMARK_FREE_THRESHOLD ? (
                        <div className="flex items-center justify-center space-x-2 text-green-400">
                          ...
                          <span>Premium access - No watermark</span>
                        </div>
                      ) : (
                        <div className="flex items-center justify-center space-x-2 text-yellow-400">
                          ...
                          <span>Need {WATERMARK_FREE_THRESHOLD - validCredits} more credits for watermark-free version</span>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      {/* 水印版本下载 */}
                      <a
                        href={`/api/baby/add-watermark?url=${encodeURIComponent(generatedBaby)}`}
                        download="ai-baby-watermarked.jpg"
                        className="bg-gradient-to-r from-gray-600 to-gray-700 text-white px-4 py-3 rounded-xl hover:from-gray-700 hover:to-gray-800 transition-all duration-300 text-sm font-medium shadow-lg hover:shadow-xl transform hover:scale-105 inline-block"
                      >
                      ...
                      {validCredits >= WATERMARK_FREE_THRESHOLD ? (
                        <a
                          href={`/api/download?url=${encodeURIComponent(generatedBaby)}&filename=ai-baby-premium.jpg`}
                        ...
                        >
                          <div className="flex items-center justify-center space-x-2">
                            ...
                            <span>Download (Premium - No Watermark)</span>
                          </div>
                        </a>
                      ) : (
                        <div className="bg-gradient-to-r from-purple-600/50 to-pink-600/50 text-white px-4 py-3 rounded-xl border border-purple-500/30 text-sm font-medium">
                          <div className="flex items-center justify-center space-x-2 mb-2">
                            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                            </svg>
                            <span>Premium Download (No Watermark)</span>
                          </div>
                          <p className="text-xs text-gray-300 mb-3">
                            Need {WATERMARK_FREE_THRESHOLD - validCredits} more credits to unlock watermark-free downloads
                          </p>
                          <button
                            onClick={() => setIsCreditsModalOpen(true)}
                            className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white px-3 py-2 rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300 text-xs font-medium"
                          >
                            Get More Credits
                          </button>
                        </div>
