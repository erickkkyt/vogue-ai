...
CREATE TABLE IF NOT EXISTS veo3_generations (
  ...
  -- 输入参数
  generation_mode VARCHAR(50) NOT NULL CHECK (generation_mode IN ('text-to-video', 'image-to-video')),
  selected_model VARCHAR(50) NOT NULL CHECK (selected_model IN ('veo3', 'veo3_fast')),
  text_prompt TEXT,
  image_url TEXT,
  image_prompt TEXT,
